...
export const GAMES: Game[] = [
  {
    ...
    bookings: [
      { id: "b0", gameId: "g1", player: PLAYERS[0], teamAssignment: "blue", paymentStatus: "paid" },
    ...
    aiAssignment: {
      teamBlue: ["Maya", "Amir Bilousov", "Matt Wang", "Chad Pratt"],
      teamRed: ["Kassim K.", "Ronan K.", "Siraseth N.", "Manon V."],
      reasoning: "Teams balanced by ELO average. Blue team avg: 1,331 · Red team avg: 1,290. Difference: 41 ELO — within acceptable balance threshold.",
      balanceScore: 97,
    },
    carpoolOffers: [
  ...
  },
  {
    ...
    bookings: [
      ...
      { id: "b12", gameId: "g2", player: PLAYERS[4], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b13", gameId: "g2", player: PLAYERS[5], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b14", gameId: "g2", player: PLAYERS[6], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b15", gameId: "g2", player: PLAYERS[7], teamAssignment: "none", paymentStatus: "paid" },
    ],
  },
  {
    id: "g3",
    ...
    description: "Chill session, all skill levels welcome! Great for newer players.",
    bookings: [
      { id: "b30", gameId: "g3", player: PLAYERS[0], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b31", gameId: "g3", player: PLAYERS[9], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b32", gameId: "g3", player: PLAYERS[10], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b33", gameId: "g3", player: PLAYERS[8], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b34", gameId: "g3", player: PLAYERS[4], teamAssignment: "none", paymentStatus: "paid" },
    ],
  },
  {
    id: "g4",
    ...
    bookings: [
      { id: "b16", gameId: "g4", player: PLAYERS[1], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b17", gameId: "g4", player: PLAYERS[2], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b18", gameId: "g4", player: PLAYERS[3], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b19", gameId: "g4", player: PLAYERS[4], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b20", gameId: "g4", player: PLAYERS[5], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b21", gameId: "g4", player: PLAYERS[6], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b22", gameId: "g4", player: PLAYERS[7], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b23", gameId: "g4", player: PLAYERS[8], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b24", gameId: "g4", player: PLAYERS[9], teamAssignment: "none", paymentStatus: "paid" },
      { id: "b25", gameId: "g4", player: PLAYERS[10], teamAssignment: "none", paymentStatus: "paid" },
    ],
  },
  {
    id: "g5",
...
export const CHAT_MESSAGES: Record<string, ChatMessage[]> = {
  g1: [
    ...
    { id: "m3", gameId: "g1", senderId: "p2", senderName: "Matt", text: "Don't be late guys, field opens 30 min before kick-off", timestamp: minsAgo(60) },
    ...
    { id: "m8", gameId: "g1", senderId: "p0", senderName: "Maya", text: "See everyone soon! 🏃‍♀️⚽", timestamp: minsAgo(10) },
  ],
  g3: [
...
export const NOTIFICATIONS: Notification[] = [
  {
    ...
    body: "You're on Team Blue for Benjakitti Park Field 1 · Starting soon",
  ...
  },
  {
    ...
    body: "Kassim K. posted a mixed game at Benjakitti Park Field 1 · 19:00",
