...
export default function LeaderboardScreen() {
  ...
  if (Platform.OS === "web") {
    const cityLabel = CITIES[city];

    return (
      <View style={[styles.container, { paddingTop: topPadding }]}>
        <ScrollView
          showsVerticalScrollIndicator={false}
          contentContainerStyle={[styles.webShell, { paddingBottom: bottomPadding + 72 }]}
        >
          ...
          <View style={styles.webHeroCard}>
            <View style={styles.webHeroText}>
              ...
              <Text style={styles.webHeroDesc}>
                Desktop view for performance leaders, monthly awards, and fairness metrics across {cityLabel}.
              </Text>
            </View>
            <View style={styles.webSummaryGrid}>
              <View style={styles.webSummaryCard}>
                <Text style={styles.webSummaryValue}>{PLAYERS.length}</Text>
                <Text style={styles.webSummaryLabel}>Players</Text>
              </View>
              <View style={styles.webSummaryCard}>
                <Text style={styles.webSummaryValue}>{displayEntries.length}</Text>
                <Text style={styles.webSummaryLabel}>Ranked entries</Text>
              </View>
              <View style={styles.webSummaryCard}>
                <Text style={styles.webSummaryValue}>{cityLabel}</Text>
                <Text style={styles.webSummaryLabel}>Active city</Text>
              </View>
            </View>
          </View>

          <View style={styles.webControlCard}>
            <View style={styles.webControlRow}>
              <View style={styles.webDropdownWrapper}>
                <Pressable
          ...
          <View style={styles.webLayout}>
            <View style={styles.webMainColumn}>
                  ...
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        ...
                        <Text style={styles.webSectionTitle}>Performance leaderboard</Text>
                      </View>
                  ...
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        ...
                        <Text style={styles.webSectionTitle}>Every player by ELO</Text>
                      </View>
                  ...
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        ...
                        <Text style={styles.webSectionTitle}>Momentum this month</Text>
                      </View>
                      <Text style={styles.listHeaderRight}>+ELO</Text>
                    </View>
                  ...
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        ...
                        <Text style={styles.webSectionTitle}>Monthly recognition</Text>
                      </View>
                      <Text style={styles.listHeaderRight}>PTS</Text>
                    </View>
                ...
                <>
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        <Text style={styles.listHeaderText}>BALLER OF THE MONTH</Text>
                        <Text style={styles.webSectionTitle}>{month} {year}</Text>
                      </View>
                      <Text style={styles.listHeaderRight}>PTS</Text>
                    </View>
                    <View style={styles.podiumContainer}>
                  ...
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        <Text style={styles.listHeaderText}>FULL RANKINGS</Text>
                        <Text style={styles.webSectionTitle}>Monthly top performers</Text>
                      </View>
                      <Text style={styles.listHeaderRight}>PTS</Text>
                    </View>
                    {rest.map((item) => (
                  ...
                  <View style={styles.webSectionCard}>
                    <View style={styles.webSectionHeader}>
                      <View>
                        ...
                        <Text style={styles.webSectionTitle}>Reliability and sportsmanship</Text>
                      </View>
              ...
              {category === "gotm" && (
                <View style={styles.webSectionCard}>
                  <View style={{ alignItems: "center", paddingVertical: 56, gap: 12, paddingHorizontal: 32 }}>
                    <Ionicons name="football-outline" size={52} color={Colors.muted} />
                    <Text style={{ fontFamily: "Inter_700Bold", fontSize: 20, color: Colors.text, textAlign: "center" }}>
                      Tor des Monats
                    </Text>
                    <Text style={{ fontFamily: "Inter_400Regular", fontSize: 13, color: Colors.muted, textAlign: "center", lineHeight: 20, maxWidth: 420 }}>
            ...
            <View style={styles.webSideColumn}>
              <View style={styles.webSideCard}>
                <Text style={styles.webSideLabel}>MONTH AT A GLANCE</Text>
                <Text style={styles.webSideTitle}>Quick stats</Text>
                <View style={styles.webMiniStats}>
                  <View style={styles.webMiniStat}>
                    <Text style={styles.webMiniStatValue}>{top3[0]?.player.eloRating ?? "—"}</Text>
                    <Text style={styles.webMiniStatLabel}>Top ELO</Text>
                  </View>
                  <View style={styles.webMiniStat}>
                    <Text style={styles.webMiniStatValue}>{eloGainers[0]?.eloGainThisMonth ?? 0}</Text>
                    <Text style={styles.webMiniStatLabel}>Best monthly gain</Text>
                  </View>
                  <View style={styles.webMiniStat}>
                    <Text style={styles.webMiniStatValue}>{cityLabel}</Text>
                    <Text style={styles.webMiniStatLabel}>City focus</Text>
                  </View>
                </View>
              </View>
              ...
              {category !== "gotm" && (
                <View style={styles.webSideCard}>
                  <Text style={styles.webSideLabel}>CATEGORY NOTES</Text>
                  <Text style={styles.webSideTitle}>{selectedCategory?.label}</Text>
                  <Text style={styles.webSideDesc}>
                    {category === "elo"
                      ? "The leaderboard is sorted by current ELO, with monthly gainers and award placement shown below."
                      : category === "botm"
                        ? "Monthly recognition combines wins, ELO growth, and community quality."
                        : "Fairness rewards reliability, sportsmanship, and consistent attendance."}
                  </Text>
                </View>
              )}
              ...
              {category === "botm" && (
                <View style={styles.webSideCard}>
                  <Text style={styles.webSideLabel}>SPOTLIGHT</Text>
                  <Text style={styles.webSideTitle}>{top3[0]?.player.name}</Text>
                  <Text style={styles.webSideDesc}>
                    Current front-runner in this month's award race with a balanced mix of wins and growth.
                  </Text>
                </View>
              )}
            </View>
...
const styles = StyleSheet.create({
  ...
  webSummaryValue: { fontFamily: "Inter_700Bold", fontSize: 24, color: Colors.text },
  webSummaryLabel: { fontFamily: "Inter_600SemiBold", fontSize: 11, color: Colors.muted, marginTop: 2 },
  webControlCard: {
    backgroundColor: Colors.surface,
    borderRadius: 20,
    padding: 18,
  ...
  webControlRow: { flexDirection: "row", alignItems: "flex-start", gap: 14 },
  webDropdownWrapper: { flex: 1, zIndex: 10 },
  webCityTabs: {
    flex: 1.2,
    flexDirection: "row",
  ...
  webMainColumn: { flex: 1.7, minWidth: 0, gap: 16 },
  webSideColumn: { flex: 0.9, minWidth: 280, gap: 16 },
  webSectionCard: {
    backgroundColor: Colors.surface,
    borderRadius: 20,
    padding: 20,
  ...
  webMiniStatValue: { fontFamily: "Inter_700Bold", fontSize: 20, color: Colors.text, textAlign: "center" },
  webMiniStatLabel: { fontFamily: "Inter_600SemiBold", fontSize: 11, color: Colors.muted, marginTop: 3, textAlign: "center" },
