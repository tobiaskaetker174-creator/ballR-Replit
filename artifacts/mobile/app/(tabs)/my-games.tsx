      ...
      return (
        <View style={[styles.container, { paddingTop: topPadding }]}>
          ...
          >
            ...
            <View style={[styles.authGate, styles.webAuthGate]}>
          ...
          <View style={styles.webHeroCard}>
            <View style={styles.webHeroText}>
              ...
              <Text style={styles.webHeroDesc}>
                Track upcoming matches, jump into chats, and clear teammate ratings from a clean desktop workspace.
              </Text>
            </View>
            <View style={styles.webSummaryGrid}>
              <View style={styles.webSummaryCard}>
                <Text style={styles.webSummaryValue}>{myGames.length}</Text>
                <Text style={styles.webSummaryLabel}>Upcoming</Text>
              </View>
              <View style={styles.webSummaryCard}>
                <Text style={styles.webSummaryValue}>{completedGames.length}</Text>
                <Text style={styles.webSummaryLabel}>Completed</Text>
              </View>
              <View style={styles.webSummaryCard}>
                <Text style={styles.webSummaryValue}>{pendingRatings.length}</Text>
                <Text style={styles.webSummaryLabel}>Pending ratings</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.webLayout}>
                ...
                <View style={styles.webSectionHeader}>
                  <View>
                    <Text style={styles.ratingSectionTitle}>
                      {activeTab === 0 ? "UPCOMING GAMES" : "COMPLETED GAMES"}
                    </Text>
                    <Text style={styles.webSectionTitle}>
                      {activeTab === 0 ? "Your next matches" : "Recent results and reviews"}
                    </Text>
                  </View>
                  <View style={styles.countChip}>
                    <Text style={styles.countChipText}>{activeGames.length} games</Text>
                  </View>
                </View>
                ...
                {activeGames.length > 0 ? (
                  <View style={styles.webCardGrid}>
                    {activeGames.map((item) => (
                      <View key={item.id} style={styles.webCardWrap}>
                        <GameCard
                          game={item}
                  ...
                  <View style={[styles.empty, { paddingTop: 44 }]}>
            ...
            <View style={styles.webSideColumn}>
              <View style={styles.webSideCard}>
                <Text style={styles.webSideLabel}>QUICK ACTIONS</Text>
                <Text style={styles.webSideTitle}>Stay on top of the squad</Text>
                <Text style={styles.webSideDesc}>
                  Use the shortcuts below to jump back into the match flow without losing context.
                </Text>
                <View style={styles.webSideActions}>
                  <Pressable style={styles.webPrimaryAction} onPress={() => router.replace("/(tabs)")}>
                    <Ionicons name="search-outline" size={16} color={Colors.text} />
                    <Text style={styles.webPrimaryActionText}>Browse Games</Text>
                  </Pressable>
                  <Pressable style={styles.webSecondaryAction} onPress={() => router.push("/notifications")}>
                    <Ionicons name="notifications-outline" size={16} color={Colors.muted} />
                    <Text style={styles.webSecondaryActionText}>Notifications</Text>
                  </Pressable>
                </View>
              </View>

              <View style={styles.webSideCard}>
                <Text style={styles.webSideLabel}>BREAKDOWN</Text>
                <View style={styles.webMiniStats}>
                  <View style={styles.webMiniStat}>
                    <Text style={styles.webMiniStatValue}>{myGames.length}</Text>
                    <Text style={styles.webMiniStatLabel}>Upcoming</Text>
                  </View>
                  <View style={styles.webMiniStat}>
                    <Text style={styles.webMiniStatValue}>{completedGames.length}</Text>
                    <Text style={styles.webMiniStatLabel}>Completed</Text>
                  </View>
                  <View style={styles.webMiniStat}>
                    <Text style={styles.webMiniStatValue}>{pendingRatings.length}</Text>
                    <Text style={styles.webMiniStatLabel}>Needs rating</Text>
                  </View>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  webMainColumn: { flex: 1.7, minWidth: 0 },
  webSideColumn: { flex: 0.9, gap: 16, minWidth: 280 },
  webSectionCard: {
    backgroundColor: Colors.surface,
    borderRadius: 20,
    padding: 20,
  ...
  webSideActions: { gap: 10, marginTop: 4 },
  webPrimaryAction: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  webPrimaryActionText: { fontFamily: "Inter_700Bold", fontSize: 13, color: Colors.text },
  webSecondaryAction: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  webSecondaryActionText: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: Colors.muted },
  webMiniStats: {
    flexDirection: "row",
    gap: 10,
    flexWrap: "wrap",
  ...
  webMiniStatValue: { fontFamily: "Inter_700Bold", fontSize: 20, color: Colors.text },
  webMiniStatLabel: { fontFamily: "Inter_600SemiBold", fontSize: 11, color: Colors.muted, marginTop: 3 },
  tabsRow: {
    flexDirection: "row",
    marginHorizontal: 16,
    backgroundColor: Colors.surface,
